...
ActiveRecord::Schema.define(version: 2021_11_10_093429) do
  ...
  create_table "orders", force: :cascade do |t|
    t.integer "line_food_id", null: false
    t.integer "total_price", default: 0, null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["line_food_id"], name: "index_orders_on_line_food_id"
  end
  ...
  add_foreign_key "orders", "line_foods"
end
